  ...
  <section id="documentos">
    <div class="py-4 mt-12 text-center">
      <span class="text-xl font-bold border-t border-b py-4 border-green-800 text-green-800"><span
          v-if="UseLang.store.lang == 'pt'">Documentos</span><span v-else>Documents</span></span>
    </div>
    ...
    <div class="flex flex-wrap mt-4">
      <div :class="[
        ...
        <div role="alert" class="alert mt-2 cursor-pointer p-3 hover:bg-gray-200" v-for="documento in documentos"
          @click="changePDF(documento.pdf)">
          <svg class="text-red-700" xmlns="http://www.w3.org/2000/svg" width="1.3em" height="1.3em" viewBox="0 0 20 20">
      ...
      <div class="w-full mt-2 md:mt-0 h-96 md:h-auto md:w-1/2 p-2 bg-gray-200 rounded-lg" id="pdf"
        v-if="!isMobileDevice()">
        <div style="width: 100%; height: 100%">
          <embed :src="state.documentoSelecionado" type="application/pdf" style="width: 100%; height: 100%" />
        </div>
      </div>
    </div>
  </section>
